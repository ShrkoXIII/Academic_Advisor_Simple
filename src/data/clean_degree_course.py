...
from src.paths import CLEAN_DEGREE_COURSE_PATH_V2, DEGREE_COURSE_PATH
...
def main():
    ...
    CLEAN_DEGREE_COURSE_PATH_V2.parent.mkdir(parents=True, exist_ok=True)
    df.to_parquet(CLEAN_DEGREE_COURSE_PATH_V2, index=False)
    print("Rows:", len(df))
    print("Unique courses:", df["course_id"].nunique())
    print("Unique degrees:", df["degree_id"].nunique())
    print("Saved:", CLEAN_DEGREE_COURSE_PATH_V2)
