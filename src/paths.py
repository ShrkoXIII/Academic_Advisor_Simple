...
GRADE_MODEL_PATH_V2 = versioned_path(GRADE_MODEL_PATH)
FAIL_MODEL_PATH_V2 = versioned_path(FAIL_MODEL_PATH)
MODEL_METADATA_PATH_V2 = versioned_path(MODEL_METADATA_PATH)
PLAN_GPA_COURSE_PREDICTIONS_PATH_V2 = versioned_path(PLAN_GPA_COURSE_PREDICTIONS_PATH)
PLAN_GPA_EVALUATION_PATH_V2 = versioned_path(PLAN_GPA_EVALUATION_PATH)
PLAN_GPA_METRICS_PATH_V2 = versioned_path(PLAN_GPA_METRICS_PATH)
MODEL_ERROR_BY_YEAR_PATH_V2 = versioned_path(MODEL_ERROR_BY_YEAR_PATH)
MODEL_ERROR_BY_DEGREE_PATH_V2 = versioned_path(MODEL_ERROR_BY_DEGREE_PATH)
MODEL_ERROR_BY_YEAR_DEGREE_PATH_V2 = versioned_path(MODEL_ERROR_BY_YEAR_DEGREE_PATH)
MODEL_ERROR_PLAN_SEGMENTS_PATH_V2 = versioned_path(MODEL_ERROR_PLAN_SEGMENTS_PATH)
MODEL_ERROR_COURSE_SEGMENTS_PATH_V2 = versioned_path(MODEL_ERROR_COURSE_SEGMENTS_PATH)
MODEL_SHAP_IMPORTANCE_PATH_V2 = versioned_path(MODEL_SHAP_IMPORTANCE_PATH)
MODEL_SHAP_FAMILY_PATH_V2 = versioned_path(MODEL_SHAP_FAMILY_PATH)
MODEL_ERROR_ANALYSIS_SUMMARY_PATH_V2 = versioned_path(MODEL_ERROR_ANALYSIS_SUMMARY_PATH)
DEGREE_POINTS_VALIDATION_PATH_V2 = versioned_path(DEGREE_POINTS_VALIDATION_PATH)
DEGREE_POINTS_VALIDATION_SUMMARY_PATH_V2 = versioned_path(DEGREE_POINTS_VALIDATION_SUMMARY_PATH)
DEGREE_POINTS_HOLDOUT_COURSES_PATH_V2 = versioned_path(DEGREE_POINTS_HOLDOUT_COURSES_PATH)
DEGREE_POINTS_HOLDOUT_PLANS_PATH_V2 = versioned_path(DEGREE_POINTS_HOLDOUT_PLANS_PATH)
DEGREE_POINTS_HOLDOUT_BY_DEGREE_PATH_V2 = versioned_path(DEGREE_POINTS_HOLDOUT_BY_DEGREE_PATH)
DEGREE_POINTS_EXPERIMENT_METADATA_PATH_V2 = versioned_path(DEGREE_POINTS_EXPERIMENT_METADATA_PATH)
DEGREE_POINTS_SELECTED_MODEL_PATH_V2 = versioned_path(DEGREE_POINTS_SELECTED_MODEL_PATH)
DEGREE_POINTS_CATEGORY_LEVELS_PATH_V2 = versioned_path(DEGREE_POINTS_CATEGORY_LEVELS_PATH)
